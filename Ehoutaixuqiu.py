...
for i in range(1):
    ...
    # 需求类型
    xqtype = ['//*[@id="app"]/div[3]/form/div[2]/div[2]/a[1]/span[1]',
              '//*[@id="app"]/div[3]/form/div[2]/div[2]/a[2]/span[1]',
              '//*[@id="app"]/div[3]/form/div[2]/div[2]/a[3]/span[1]',
              '//*[@id="app"]/div[3]/form/div[2]/div[2]/a[4]/span[1]',
              '//*[@id="app"]/div[3]/form/div[2]/div[2]/a[5]/span[1]']
    ...
    xpah_sendk('//*[@id="app"]/div[3]/div[2]/form/div[1]/div/div[3]/div/div/div[2]/form/div[3]/div/div[1]/textarea',
               u"履历履历履历履历履历履历履历履历履历履历履历")
    ...
    xpath_click(
        '//*[@id="app"]/div[3]/div[2]/form/div[2]/div[4]/div/div/div[2]/div[1]/div/div[2]/div[1]/div/button/span')
    os.system("F:\\py\\pysele\\autoJpg.exe")
    time.sleep(3)
    xpath_click(
        '//*[@id="app"]/div[3]/div[2]/form/div[2]/div[4]/div/div/div[2]/div[2]/div/div[2]/div[1]/div/button/span')
    os.system("F:\\py\\pysele\\autoJpg.exe")
    time.sleep(2)
    ...
    xpah_sendk(
        '//*[@id="app"]/div[3]/div[2]/form/div[2]/div[2]/div[2]/div/div/div[2]/form/div[1]/div/div[1]/div/div/div/input',
        u'0')
    xpah_sendk(
        '//*[@id="app"]/div[3]/div[2]/form/div[2]/div[2]/div[2]/div/div/div[2]/form/div[1]/div/div[2]/div/div/div/input',
        u'0')
    xpah_sendk(
        '//*[@id="app"]/div[3]/div[2]/form/div[2]/div[2]/div[2]/div/div/div[2]/form/div[2]/div/div[1]/div/div/div/input',
        u'0')
    xpah_sendk(
        '//*[@id="app"]/div[3]/div[2]/form/div[2]/div[2]/div[2]/div/div/div[2]/form/div[2]/div/div[3]/div/div/div/input',
        u'0')
